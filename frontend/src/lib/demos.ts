...
export const DEMO_SCENARIOS: DemoVideo[] = [
  ...
  },
  {
    ...
    expectedMovement: "medium",
    hint: "同一隻狗、同一個客廳、固定鏡頭。示範標籤依時間切換；真實 CV 仍獨立運行。",
    expectedActivities: [
      { start: 0, end: 2.2, activity: "resting", label: "休息", icon: "💤" },
      { start: 2.2, end: 3.2, activity: "exploring", label: "開始走動", icon: "🚶" },
      { start: 3.2, end: 5.2, activity: "playing", label: "開始玩耍", icon: "🎾" },
      { start: 5.2, end: 7.2, activity: "eating", label: "進食", icon: "🦴" },
      { start: 7.2, end: 10.1, activity: "exploring", label: "再次走動", icon: "🚶" },
    ],
  },
];
